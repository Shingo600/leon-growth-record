  ...
  return (
    <section className="card space-y-4 p-5">
      ...
      <p className="text-sm leading-6 text-ink/70">
        ごはんを記録するときに選ぶ候補です。商品名やカロリー、1食目安を先に登録しておくと入力が楽になります。
      </p>
      ...
      {open ? (
        <div className="fixed inset-0 z-[110] bg-ink/35" onClick={closeModal}>
          <div className="flex min-h-full items-end justify-center px-4 pb-6 pt-10 sm:items-center">
            ...
            >
              <div className="mb-4 flex items-center justify-between gap-3">
                <h4 className="text-lg font-semibold">{editingId ? "フードを編集" : "フードを追加"}</h4>
                <button type="button" className="button-secondary cursor-pointer px-4 py-2" onClick={closeModal}>
                  閉じる
                </button>
              </div>
